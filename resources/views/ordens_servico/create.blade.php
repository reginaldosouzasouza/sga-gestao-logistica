    ...
    <form action="{{ route('ordens-servico.store') }}" method="POST">
       ...
       <div class="form-grid">
            <div class="form-group">
             ...
             <input type="number" name="id" class="form-control" value="{{ $proximoId }}" readonly>
            ...
            <div class="form-group">
                ...
                <input type="date" name="data_lancamento" class="form-control" value="{{ old('data_lancamento') }}">
            </div>
            ...
            <div class="form-group">
                <label for="status">Movimentação O.S</label>
                <select name="status" id="status" class="form-control">
                    ...
                    <option value="Reparado">Reprovado</option>
