...
<div class="container">
  ...
  <a href="{{ route('padoca.encomendas.index') }}" class="btn btn-outline-secondary mb-3">← Voltar</a>
  <a href="{{ route('padoca.encomendas.show',$encomenda) }}" class="btn btn-info mb-3">Ver Detalhes</a>
  ...
  <form method="POST" action="{{ route('padoca.encomendas.update',$encomenda) }}">
    @csrf @method('PUT')
