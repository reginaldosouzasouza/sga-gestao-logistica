...
<div class="container">
    ...
    <form method="POST" action="{{ route('padaria.encomendas.store') }}" id="form-encomenda">
        @csrf
    <div class="row mb-3">
    <div class="col-md-3">
...
<div class="row mb-3">
  ...
  <div class="col-md-4">
      ...
      <input type="number" step="0.01" name="sinal" class="form-control" value="0">
        ...
        <a href="{{ route('padaria.encomendas.index') }}" class="btn btn-outline-secondary">Cancelar</a>
    </form>
</div>
