...
<head>
    ...
    <title>Menu Principal - PROJETO GÁS</title>
    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            background-color: rgba(37, 179, 222, 0.661);
        }
        ...
        /* Mostrar submenu "Estoque" quando ativo 
        .menu-link.active + #estoque-submenu {
            display: block;
            padding: 40px;
            margin: 10px;
        ...
        /* Mostrar submenu "Vendas" quando ativo 
        .menu-link.active + #vendas-submenu {
            display: block;
            padding: 40px;
            margin: 10px;
            left: 100%;
...
<body>
        ...
        <ul>
            <li class="dropdown">
                ...
                <div class="dropdown-submenu">
                    ...
                    <a href="http://127.0.0.1:8001/compras" target="_blank">Usuários<img src="images/imagem/usuarios.png" class="imagem"></a>
                </div>
            </li>
    ...
    <!--      <li class="dropdown">
                <a href="#">Faturamento<i class="bi bi-caret-down-fill"></i></a>
                <div class="dropdown-submenu">
                    <a href="http://127.0.0.1:8000/clientes" target="_blank">Pedidos de Coleta<img src="./imagem/clientes.png" class="imagem"></a>
                    <a href="http://127.0.0.1:8000/compras/create" target="_blank">Ordens de Serviços<img src="./imagem/compras.png" class="imagem"></a>
                    <a href="http://127.0.0.1:8000/formas_de_pagamento" target="_blank">Formas de Pagamento<img src="./imagem/formasdepagamento.png" class="imagem"></a>
                    <a href="http://127.0.0.1:8000/fornecedores" target="_blank">Fornecedor<img src="./imagem/fornecedor.png" class="imagem"></a>
                    <a href="http://127.0.0.1:8000/produtos" target="_blank">Produtos<img src="./imagem/produtos.png" class="imagem"></a>
                    <a href="http://127.0.0.1:8000/compras" target="_blank">Usuários<img src="./imagem/usuarios.png" class="imagem"></a>
                </div>
            </li> -->
            ...
            <li class="dropdown">
                ...
                <div class="dropdown-submenu">
                    ...
                    <a href="http://127.0.0.1:8001/compras" target="_blank">COMPRADO<img src="images/imagem/usuarios.png" class="imagem"></a>
                </div>
            </li>
            ...
            <li>
                <div class="gestao">
                    <h1>
                        SGA - Sistema de Gestão Aplicada - Projeto GÁS
                        <div id="date-time">
                            <p id="date"></p>
                            <p id="time"></p>
                        </div>
