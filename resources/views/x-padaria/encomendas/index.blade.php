...
<div class="container">
    ...
    <form method="GET" class="mb-3" style="display:grid;grid-template-columns:repeat(5,1fr);gap:8px;align-items:end;">
        ...
        <div>
            ...
            <input type="date" name="data_fim" value="{{ request('data_fimencomenda') }}" class="form-control">
        </div>
        <div>
    ...
    <div class="mb-2">
        <a href="{{ route('padaria.encomendas.create') }}" class="btn btn-success">Nova Encomenda</a>
    </div>
    ...
    <table class="table table-bordered">
        ...
        {{-- PAGAMENTO --}}
            ...
            <td>
        @php
            $pago = ($e->pagamento_status === 'Pago');
        @endphp

        {{-- Regra:
            - Se estiver "Pago": mostra a forma (se existir) e o badge "Pago"
            - Se estiver "Pendente": mostra só o badge "Pendente" (sem forma) --}}
        ...
        <td style="white-space:nowrap;">
            <a href="{{ route('padaria.encomendas.show',$e) }}" class="btn btn-sm btn-info">Ver</a>
            <a href="{{ route('padaria.encomendas.edit',$e) }}" class="btn btn-sm btn-warning">Editar</a>
            <form action="{{ route('padaria.encomendas.destroy',$e) }}" method="POST" style="display:inline;">
                @csrf @method('DELETE')
    ...
    {{-- ESTA LINHA É A PAGINAÇÃO QUE MANTÉM OS FILTROS --}}
