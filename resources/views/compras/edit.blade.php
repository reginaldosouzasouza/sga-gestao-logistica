...
<body>
    <div class="container">
        ...
        <div class="back-button">
            <button onclick="window.location.href='{{ route('compras.index') }}'" class="btn-voltar_index">Voltar</button>
        </div>
        ...
        <form action="{{ route('compras.update', $compra->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="nota_fiscal" name="nota_fiscal" value="{{ intval($compra->nota_fiscal) }}" step="1">
            </div>

            <div class="form-group">
                <label for="data_vencimento">Data de Vencimento:</label>
                <input type="date" name="data_vencimento" class="form-control" 
                    value="{{ old('data_vencimento', \Carbon\Carbon::parse($compra->data_vencimento)->format('Y-m-d')) }}" required>
            </div>
