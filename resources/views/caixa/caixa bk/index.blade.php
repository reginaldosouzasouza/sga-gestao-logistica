...
<div class="container">
    ...
    @if(isset($caixa) && $caixa)
        ...
        @endif
    @else
    <!--    <p style="color: red; font-size: 18px; font-weight: bold;">Nenhum caixa aberto no momento.</p>
        @if(!$caixa)
            <p style="color: red; font-weight: bold;">Nenhum caixa aberto no momento.</p>-->
    
            <!-- Formulário para abrir o caixa -->
            <h3>Abrir Caixa</h3>
        ...
        <!-- Formulário para abrir um novo caixa -->
   <!--     <h3>Abrir Caixa</h3>
        <form action="{{ route('caixa.abrir') }}" method="POST">
            @csrf
            <label><strong>Saldo Inicial:</strong></label>
            <input type="text" name="saldo_inicial" placeholder="Digite o saldo inicial" required>
