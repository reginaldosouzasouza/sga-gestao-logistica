  ...
  @if(isset($caixaAbertoHoje) && $caixaAbertoHoje === null)
    ...
    <form action="{{ route('caixa.ajuste') }}" method="POST" style="margin-bottom:30px;">
        ...
        <div style="display:flex; gap:10px; flex-wrap:wrap;">
            ...
            <input type="text" name="descricao" class="form-control" placeholder="Ex: Sangria / Reforço" required>

            <button type="submit" class="btn btn-warning">➕ Ajuste Manual</button>
        </div>
    </form>
    @endif
