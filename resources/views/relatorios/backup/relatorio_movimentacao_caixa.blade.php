            ...
            <div style="display:flex; gap:14px; flex-wrap:wrap; align-items:flex-end;">
                ...
                <div id="filtro-periodo" style="display:{{ $filtroTipo==='periodo'?'flex':'none' }}; gap:10px; align-items:flex-end; flex-wrap:wrap;">
                    <div>
                        ...
                        <input type="date" name="data_inicio" value="{{ $inicio->format('Y-m-d') }}"
                               style="padding:7px 12px; border:1px solid #d1d5db; border-radius:6px; font-size:13px;">
                    </div>
                    <div>
                ...
                <div id="filtro-mes" style="display:{{ $filtroTipo==='mes'?'flex':'none' }}; gap:10px; align-items:flex-end; flex-wrap:wrap;">
                    <div>
                        ...
                        <select name="mes" style="padding:7px 12px; border:1px solid #d1d5db; border-radius:6px; font-size:13px;">
                    ...
                    <div>
                        ...
                        <select name="ano" style="padding:7px 12px; border:1px solid #d1d5db; border-radius:6px; font-size:13px;">
                ...
                <div>
                    ...
                    <select name="origem" style="padding:7px 12px; border:1px solid #d1d5db; border-radius:6px; font-size:13px;">
                        <option value="">Todas</option>
                        @foreach($origens as $o)
                            <option value="{{ $o }}" {{ $filtroOrigem==$o?'selected':'' }}>{{ ucfirst($o) }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select name="forma_pagamento" style="padding:7px 12px; border:1px solid #d1d5db; border-radius:6px; font-size:13px;">
                        <option value="">Todas</option>
                        @foreach($formasPagamento as $id => $nome)
                            <option value="{{ $nome }}" {{ $filtroForma==$nome?'selected':'' }}>{{ $nome }}</option>
                        @endforeach
                    </select>
                </div>
