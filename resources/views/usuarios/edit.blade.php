...
<div class="container usuario-form-page">
    <div class="usuario-form-card">
        <div class="usuario-form-topo">
            <h2 class="usuario-form-titulo">Editar Usuário</h2>
            <p class="usuario-form-subtitulo">
                Atualize os dados do usuário, tipo de acesso, perfil e senha quando necessário.
            </p>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="tipo" class="form-select">
                            <option value="FUNCIONARIO" {{ old('tipo', $usuario->tipo) == 'FUNCIONARIO' ? 'selected' : '' }}>
                                Funcionário
                            </option>
