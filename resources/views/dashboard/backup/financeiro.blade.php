    ...
    <div class="container">
        ...
        <div class="grid-cards">
            ...
            <div class="card amber">
                ...
                <div class="value">{{ moeda($cards['contas_pagar_aberto']) }}</div>
                <div class="detail">
            ...
            <div class="panel">
                ...
                <div class="kpi-list">
                    <div class="kpi-item tooltip-card"
                        ...
                        <small>Projeção de Despesas do Mês (pagos + a pagar)</small>
                    ...
                    <div class="kpi-item highlight tooltip-card"
                        ...
                        <small>Projeção de Recebimento do Mês (base até ontem)</small>
                        <strong>{{ moeda($cards['projecao_recebimento_mes']) }}</strong>
                    </div>

                    <div class="kpi-item tooltip-card"
                         data-tooltip="Mostra quanto ainda falta receber para que o mês cubra toda a despesa projetada. Fórmula: Projeção de Despesas do Mês - Recebido no Mês até Ontem.">
                        <small>Falta Receber para Cobrir o Mês</small>
                    ...
                    <div class="kpi-item tooltip-card"
                        ...
                        <small>Meta Diária para Cobrir o Contas a pagar em Aberto</small>
                        <strong class="text-orange">{{ moeda($cards['meta_diaria_cobrir_aberto']) }}</strong>
                    </div>

                    <div class="kpi-item tooltip-card"
                         data-tooltip="Meta diária necessária para o mês terminar cobrindo toda a despesa projetada. Fórmula: Falta Receber para Cobrir o Mês ÷ Dias Restantes.">
                        <small>Meta Diária para Fechar o Mês</small>
                ...
                <div class="status-box {{ $cards['status_meta'] === 'VAI ATINGIR' ? 'status-ok' : 'status-risk' }}">
                    ...
                    Se a projeção de recebimento do mês for maior ou igual à projeção de despesas, o mês tende a fechar coberto.
                </div>
            </div>
        </div>
