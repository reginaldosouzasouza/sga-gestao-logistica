...
<style>
    ...
    .vale-gas-page .filtros .form-control,
    .vale-gas-page .filtros .form-select {
        height: 42px;
        border-radius: 8px;
    }

    .vale-gas-page .filtros .mb-3 {
        margin-bottom: 18px !important;
    }

    .vale-gas-page .acoes-filtro {
        gap: 8px;
    }
        ...
        <div class="card-body filtros">
            <form method="GET" action="{{ route('vale-gas.index') }}">
                <div class="row">
                    ...
                    <div class="col-md-2 mb-3 d-flex align-items-end acoes-filtro">
                    ...
                    <tbody>
                        @forelse($vales as $vale)
                            <tr>
                                ...
                                <td>{{ number_format($vale->quantidade) }}</td>
                                    ...
                                    <div class="acoes-wrap">
                                        ...
                                        @if($vale->status === 'ABERTO')
                                            <form action="{{ route('vale-gas.iniciar-retirada', $vale->id) }}" method="POST" class="m-0 p-0"
                                                ...
                                                @csrf
                                                <button type="submit" class="btn btn-sm btn-warning btn-acoes">
                                                    Retirada
                                                </button>
                                            </form>
