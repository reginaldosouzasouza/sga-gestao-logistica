...
CREATE TABLE `fechamentos_caixa` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `fechamentos_caixa_data_unique` (`data`)
...
INSERT INTO `fechamentos_caixa` VALUES (1,'2026-01-26',494.50,0.00,394.50,100.00,NULL,'2026-01-26 17:16:18','2026-01-26 17:16:18');
