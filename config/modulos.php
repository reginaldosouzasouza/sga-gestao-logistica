 ...
 *   - cor        : classe CSS (mod-oficina, mod-gas, etc.)
 *   - accent     : cor hex usada no JS de fallback
 *   - menu       : array de grupos/itens que aparecem NA NAV
 *
 * Itens "base" (Cadastro, Financeiro, Relatórios, Sair) ficam no
 * menu.blade.php e são comuns a todos os módulos.
 *
 * Cada item pode ser:
 *   [ 'label', 'url', 'icone' ]               → link simples
 *   [ 'label', '#', 'icone', 'filhos' => [...] ] → dropdown
 */
    ...
    'oficina' => [
        ...
        'menu'   => [
            [
                ...
                'icone'  => '',
                'filhos' => [
                    ['label' => 'Ordens de Serviço',       'url' => '/ordens-servico'],
                    ['label' => 'Criar Ordem de Serviço',  'url' => '/ordens-servico/create'],
            ...
            [
                ...
                'filhos' => [
                    ['label' => 'Ordens de Serviço',       'url' => '/ordens-servico'],
                    ['label' => 'Criar Ordens de Serviços','url' => '/ordens-servico/create'],
                    ['label' => 'Cad. Mecânicos',          'url' => '/mecanicos'],
                ],
            ],
        ],
    ],
