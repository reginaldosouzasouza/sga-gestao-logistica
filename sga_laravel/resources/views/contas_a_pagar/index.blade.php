...
<form action="{{ route('contas-a-pagar.index') }}" method="GET"         class="form-filtro mb-3">
 ...
 <!--   <div class="form-group">
        <label for="created_at"><strong>Data de Emissão:</strong></label>
        <input type="date" name="created_at" value="{{ request('created_at') }}" class="form-control">
    </div>

    <div class="form-group">
        <label for="data_compra"><strong>Data da Compra:</strong></label>
        <input type="date" name="data_compra" value="{{ request('data_compra') }}" class="form-control">
    </div>-->
