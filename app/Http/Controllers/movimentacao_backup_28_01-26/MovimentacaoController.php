...
class MovimentacaoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            // 💳 CARTÃO / PRAZO → CONTAS A RECEBER
            else {
                $prazoDias = intval($prazoSelecionado->prazo);
                ...
                ContasAReceber::create([
                    ...
                    'data_vencimento' => Carbon::parse($movimentacao->data_coleta)->addDays($prazoDias),
            ...
            DB::rollBack();
            Log::error('Erro ao salvar movimentação', ['erro' => $e->getMessage()]);

            return redirect()
                ->back()
                ->withErrors('Erro ao salvar a movimentação: ' . $e->getMessage());
        }
    }
