...
async function carregarDashboard() {
    try {
        ...
        // =======================
        // ✅ GRÁFICO RECEITA x DESPESA (JÁ VEM SOMADO DO BACKEND)
        // =======================
        const ctxRD = document.getElementById("chartReceitaDespesa");
        
        // ✅ Backend já soma tudo, só pegar os valores
        const receitaTotal = json.serie_dias.receita[0] || 0;
        const despesaTotal = json.serie_dias.despesa[0] || 0;
        ...
        if (!chartReceitaDespesa) {
            ...
            chartReceitaDespesa.data.datasets[0].data = [receitaTotal, despesaTotal];
